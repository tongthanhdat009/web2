...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th4 28, 2025 lúc 05:30 AM
...
INSERT INTO `chitietphieunhap` (`IDChiTietPhieuNhap`, `MaPhieuNhap`, `MaHangHoa`, `IDKhoiLuongTa`, `IDKichThuocQuanAo`, `IDKichThuocGiay`, `GiaNhap`, `GiaBan`, `SoLuong`, `SoLuongTon`) VALUES
(1, 1, 61, NULL, NULL, NULL, 120000, 150000, 30, 1),
(2, 1, 44, NULL, 2, NULL, 200000, 250000, 10, 10),
(3, 1, 76, NULL, NULL, NULL, 150000, 200000, 10, 30),
(4, 2, 21, NULL, NULL, NULL, 160000, 210000, 5, 5),
(10, 2, 3, 7, NULL, NULL, 150000, 170000, 10, 30),
(11, 2, 1, 6, NULL, NULL, 150000, 180000, 10, 30),
(14, 44, 20, NULL, NULL, NULL, 50000, 5000000, 5, 5),
(15, 44, 23, NULL, 3, NULL, 50000, 500000, 5, 5),
(16, 2, 2, 6, NULL, NULL, 150000, 180000, 10, 30),
(17, 1, 44, NULL, 3, NULL, 200000, 250000, 10, 10);
...
(44, 15, 'Nike One Dri-FIT Leggings', 2, NULL, 'Nike One Dri-FIT Leggings\n', 0, '../assets/AnhHangHoa/44.png', 1),
...
(44, 'Đã Duyệt', 1, 1, '2025-04-28 00:00:00');
...
--
ALTER TABLE `chitietphieunhap`
  MODIFY `IDChiTietPhieuNhap` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `khohang`
  MODIFY `Seri` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `phieunhap`
  MODIFY `MaPhieuNhap` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;
